<div class="features_items">
    <h2 class="title text-center">Brand Product</h2>
    <?php foreach ($publish_product as $view_product) { ?>
        <div class="col-sm-4">
                ...
                <div class="single-products">
                    ...
                    <div class="product-overlay">
                        <div class="overlay-content">
                            ...
                            <a href="<?php echo base_url() ?>Welcome/product_details/<?php echo $view_product->product_id ?>" class="btn btn-default add-to-cart"><i class="fa fa-amazon"></i>product details</a>
                        </div>
                    </div>
                </div>
                <div class="choose">
