                ...
                <div class="single-products">
                    ...
                    <div class="product-overlay">
                        <div class="overlay-content">
                            ...
                            <a href="<?php echo base_url(); ?>Welcome/product_details/<?php echo $view_product->product_id; ?>" class="btn btn-default add-to-cart"><i class="fa fa-product-hunt"></i>Product details</a>
                        </div>
                    </div>
                </div>
                <div class="choose">
